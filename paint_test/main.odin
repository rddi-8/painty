                        ...
                        else
                        {
                            ...
                            if lastpos.x >= 0 {
                                for t: f32; t < dist; t = t + step {
                                    ...
                                    if use_opacity do custom_blend_simd(brush, stroke_layer, int(pos.x) - int(BRUSH_W/2), int(pos.y) - int(BRUSH_H/2))
                                    else do custom_blend_basic(brush, stroke_layer, int(pos.x) - int(BRUSH_W/2), int(pos.y) - int(BRUSH_H/2))
                                } 
                            }
                            else {
                                if use_opacity do custom_blend_simd(brush, stroke_layer, int(curpos.x) - int(BRUSH_W/2), int(curpos.y) - int(BRUSH_H/2))
